...
reset_parasitics
extractRC
rcOut -setload ./RC_timing/iir_filter.setload -rc_corner my_rc
rcOut -setres ./RC_timing/iir_filter.setres -rc_corner my_rc
rcOut -spf ./RC_timing/iir_filter.spf -rc_corner my_rc
rcOut -spef ./RC_timing/iir_filter.spef -rc_corner my_rc
...
reportGateCount -level 5 -limit 100 -outfile ./areaReport/iir_filter.gateCount
saveNetlist ./netlist/iir_filter.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network ./netlist/iir_filter.sdf
