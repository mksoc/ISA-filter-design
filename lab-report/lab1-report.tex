...
\begin{table}[hbtp]
    ...
    \begin{tabular}{|l|l|}
    \hline
    $f_{max}$     & $\SI{352.11}{MHz}$              \\ \hline % 352.11 MHz
    Area          & $\SI{4705.51}{\micro\meter^2}$ \\ \hline % 4705 um2
    Dynamic power & $\SI{86.08}{\micro\watt}$     \\ \hline % 86.08 uW
    Static power  & $\SI{81.55}{\micro\watt}$      \\ \hline % 15.52 uW
    \end{tabular}
...
\begin{table}[hbtp]
    ...
    \hline
    $f$           & $\SI{88.8}{MHz}$                \\ \hline
    Area          & $\SI{3919.2}{\micro\meter^2}$   \\ \hline % 3904.3 um2
    Dynamic power & $\SI{1599}{\micro\watt}$        \\ \hline % same...
    Static power  & $\SI{79.4}{\micro\watt}$        \\ \hline % same...
    \end{tabular}
